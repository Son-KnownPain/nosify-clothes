    ...
    <jsp:body>
        <div class="content-main">
            ...
            <div class="interact-form-box">
                <form:form class="interact-form" action="${pageContext.request.contextPath}/admin/product/update" method="POST" modelAttribute="productEdit" enctype="multipart/form-data">
                    ...
                    <div class="interact-form-group">
                        ...
                        <div class="interact-form-image-preview" style="background-image: url('${pageContext.request.contextPath}/resources/images/product/${productEdit.thumbnail}')"></div>
