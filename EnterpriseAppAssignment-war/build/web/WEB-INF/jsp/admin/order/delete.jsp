...
<t:admin_layout>
    ...
    <jsp:body>
        <div class="content-main">
            <h1 class="page-title">Delete Order</h1>
            ...
            <div class="interact-form-delete">
                ...
                <form:form action="${pageContext.request.contextPath}/admin/order/delete" method="POST" modelAttribute="orderDelete">
                    <input type="hidden" name="_method" value="DELETE" />
                    <form:hidden path="id" />
                    <a href="${pageContext.request.contextPath}/admin/order" class="interact-form-cancel-btn">Cancel</a>
